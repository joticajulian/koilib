...
export class VariableBlob {
    ...
    write(data: string | Uint8Array, length = 0) {
      let bytes =
        typeof data === "string" ? multibase.decode(data) : data;
    ...
    read(size: number, outputString = false, nameOrCode: multibase.BaseNameOrCode = "M"): Uint8Array | string {
    ...
    deserializeBuffer(outputString = false, nameOrCode: multibase.BaseNameOrCode = "M"): Uint8Array | string {
